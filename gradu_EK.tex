...
Graafin lyhyimmän polun ongelmaa on tutkittu jo vuosikymmenten ajan. Vanhimmat ja tunnetuimmat algoritmit, Dijkstran algoritmi \parencite{dijkstra1959note} ja A*-algoritmi \parencite{hart1968formal}, esiteltiin jo 50- ja 60-luvuilla, mutta näistä A*-algoritmi on selvästi tunnetumpi videopelien ja robottien reitinhaussa \parencite{cui2011based,abd2015comprehensive}.

A*-algoritmin toiminta perustuu lyhyimmän reitin etsimiseen heuristiikan avulla. Heuristiikkana käytetään usein Euklidista etäisyyttä, Manhattan-etäisyyttä tai Chebyshev-etäisyyttä. (KESKEN)
