...
Naiivi Bayes-luokittelija (engl. Naive-Bayes) on myös ohjatussa oppimisessa käytetty luokittelumenetelmä, jolla pyritään luokittelemaan aineisto todennäköisyyksien avulla \parencite{nasteski2017overview,rish2001empirical}. Naiivi-Bayes-luokittelijassa aineiston ominaisuudet oletetaan riippumattomiksi luokan suhteen. Naiivi Bayes-luokittelija onnistuu hyödyntämään tehokkaasti aiempaa tietoa luokitteluongelmien ratkaisussa.

Tukivektorikoneet (engl. support vector machines, SVM) ..
...
TODO: tukivektorikoneet, naiivi bayes luokittelijasta lisää, ohjatun oppimisen haasteita/heikkouksia..hieman niukka kappale, mahdollisesti lisää tekstiä.
