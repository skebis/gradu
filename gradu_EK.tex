...
- Artikkeleita on etsitty pääasiassa hakusanoilla pathfinding, path planning,
machine learning, video games, Unity, reinforcement learning. Myöhemmin on tarkoitus etsiä myös
artikkeleita tutkimusmetodista ja yleisesti koneoppimisesta jne.

- Hakukoneena käytetty Google Scholaria (myöhemmin tietysti useampia eri hakukoneita esim. ACM, Sciencedirect jne.).

- Ensimmäiset artikkelit valittu melko satunnaisesti avainsanojen ja aiheen samankaltaisuuden mukaan.

\chapter{Tutkimusaihe/tutkimuskysymys}

- Miten koneoppimisagentin suorittama reitinhaku vertautuu A*-algoritmiin nopeuden ja tarkkuuden osalta?

- Onko mahdollinen vaikutus negatiivinen, positiivinen vai merkityksetön?

- Onko mahdollista opettaa harjoitusdatan avulla agentti, joka suoriutuu reitinhakutehtävästä (tai -tehtävistä)
paremmin kuin A*-algoritmi?

- Löytyykö reitinhakutehtävä, jota A*-algoritmi ei pysty ratkaisemaan, mutta koneoppimisagentti pystyy?
...
- Haarnoja, T., Pong, V., Hartikainen, K., Zhou, A., Dalal, M. ja Levine, S., Soft Actor Critic - Deep Reinforcement Learning with Real-World Robots, 2018,
BAIR - Berkeley Artificial Intelligence Research, https://bair.berkeley.edu/blog/2018/12/14/sac/

-Juliani, A., Berges, V., Teng, E., Cohen, A., Harper, J., Elion, C., Goy, C., Gao, Y., Henry, H., Mattar, M. ja Lange, D., Unity: A General Platform for Intelligent Agents, 2020, arXiv preprint arXiv:1809.02627. https://github.com/Unity-Technologies/ml-agents.
