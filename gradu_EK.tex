...
Yksi suorituskykyyn liittyvistä ongelmista on reitinhakualgoritmien huono skaalautuvuus. Jos agentin reitinhakuun sovelletaan A*-algoritmia suurella 1000x1000 pelialueella, muistiin joudutaan tallentamaan jopa miljoona solmua \parencite{cui2011based,duchovn2014path}. Ongelma moninkertaistuu, jos alueella liikkuu useita reitinhakuagentteja. Esimerkiksi A*-algoritmi osoittautuu riittämättömäksi ongelman ratkaisuun, joten tilanteeseen sovelletaan erilaisia menetelmiä tai algoritmien variaatioita.
