...
Syväoppimista on tutkittu tietotekniikan alalla jo useita vuosikymmeniä, mutta viime vuosina sen tutkimus on ottanut suurimpia harppauksia. Syväoppimisella ollaan onnistuttu ratkaisemaan ongelmia, joita tekoälyn tutkimuksessa on yritetty ratkaista vuosia \parencite{lecun2015deep}. Erityisesti tuloksia on tullut kuvantunnistuksessa, puheentunnistuksessa ja erilaisissa luonnollisen kielen prosessoinnin tehtävissä \parencite{lecun2015deep}.

\subsection{Syväoppimisen perusteet}

Syväoppimisen historia...

TODO: mistä termi, neuronit, painoarvot, monitasoisuus, backpropagation, gradient descent..
